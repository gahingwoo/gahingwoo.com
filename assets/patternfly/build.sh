...
PKG="$1"; OUT=assets/patternfly
{
  ...
  for c in Page/page Masthead/masthead Button/button Card/card DescriptionList/description-list \
           Table/table Table/table-grid DataList/data-list Nav/nav TextInputGroup/text-input-group Menu/menu BackToTop/back-to-top SkipToContent/skip-to-content JumpLinks/jump-links; do
